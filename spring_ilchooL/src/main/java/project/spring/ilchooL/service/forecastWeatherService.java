...
public interface forecastWeatherService {
	...
	//x좌표:61, y좌표:126 - 강남구 (로그인 전 기본위치)
			...
			@GET("/1360000/VilageFcstInfoService_2.0/getVilageFcst?serviceKey=StBzGzV%2BbfGoWn%2F3PAB08w9ZZmJSz0lOX3%2BE8MlTapZsJqETWwd71dB8syBPznAhytzUVYMLSjXVxm5i5CADMA%3D%3D&pageNo=1&numOfRows=266&dataType=JSON&base_time=2300&nx=61&ny=126")
			Call<forecastWeather> getforecastWeather(@Query("base_date") String prev_date);
