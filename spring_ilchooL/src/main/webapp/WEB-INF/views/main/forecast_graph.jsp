...
<body>
	<div id="forecast_box" class="container">
		...
		<div id="forecast_graph" class="forecast row">
			<div id="pm10Chart" class="forecast_chart_container col-md-4 col-xs-4" style="height: 49% !important;">
				</div>
			<div id="pm25Chart" class="forecast_chart_container col-md-4 col-xs-4" style="height: 49% !important;">
				</div>
			<div id="ptyChart" class="forecast_chart_container col-md-4 col-xs-4" style="height: 49% !important;">
				</div>
		</div>
		<div class="nonbox" style="height: 150px;"></div>
		...
		//---미세먼지 데이터 시각화---
 		am4core.ready(function() {
			...
			label_pm10.adapter.add("text", function(text, target){
			  return "[font-size:13px]한달 간[/]\n[bold font-size:16px]미세먼지[/]";
			})
			});
