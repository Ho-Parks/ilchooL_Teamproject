...
<body>
	...
	<!-- wrapper -->
			<div class="container">
				...
				<div class="mypage_logo">
					<h1>
						<img src="${pageContext.request.contextPath}/assets/img/mypage_logo.png">내 정보 수정
					</h1>
				</div>
				<!-- content-->
				<div id="inner_join">
							...
							<span class="box new_pass"> 
								<input type="password" id="new_pw" class="new" name="new_pw" maxlength="20">
									<span id="alertTxt2">사용불가</span> 
										<img src="${pageContext.request.contextPath}/assets/img/login_new_pass.png" id="new_pw_img2" class="new_pw_img">
							</span> 
							<span class="error_next_box"></span>
						</div>
						...
						<div>
							...
							<span class="box new_pass_check"> 
								<input type="password" id="new_pw_re" name="new_pw_re" class="new" maxlength="20">
									<img src="${pageContext.request.contextPath}/assets/img/login_new_check_disable.png" id="new_pw_re_img1" class="new_pw_img">
							</span> 
							<span class="error_next_box"></span>
						</div>
	...
	<script src="${pageContext.request.contextPath}/assets/js/mypage2.js"></script>
	<script src="${pageContext.request.contextPath}/assets/js/user_delete.js"></script>
